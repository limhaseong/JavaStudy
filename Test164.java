	...
	: Collection Framework에는
	  ...
	  - java.util.Enumeration<E> 인터페이스
		  ...
		  ex) // v 라는 벡터 자료구조에 저장된 모든 요소 출력
		      for (Enumeration e = v.elements(); e.hasMoreElements(); )          hasMoreElements -> s 있음, nextElement -> s 없음.
			  {
	  ...
	  - java.util.Iterator<E> 인터페이스
		  ...
		  (Enumeration만 사용하는 컬렉션이 있고 Iterator만 사용하는 컬렉션이 있으므로
		   호환성 문제 때문에 둘다 사용할 줄 알아야 한다.)
*/

...
public class Test160
{
	...
	public static void main(String[] args)
	{
		...
		int idxBlue = Collections.binarySearch(v, "파랑");  //v - 자료구조, 다음 찾을 거
		...
		System.out.println();
		//분홍 : -2번째 인덱스에 위치하고 있다. -> 음수가 나왔다는 것은 존재하지 않는다는 것.

		// 내림차순 정렬(내림차순 메소드는 따로 없다.)
		...
		//내림차순 정렬 후 검색 테스트
		idxBlue = Collections.binarySearch(v, "파랑");  //v - 자료구조, 다음 찾을 거
		System.out.printf("파랑 : %d번째 인덱스에 위치하고 있다. \n", idxBlue);
		System.out.println();
		//파랑 : -8번째 인덱스에 위치하고 있다.
		//-> 파랑을 제대로 못 찾았다. ->binarySearch() = 오름차순이 되어있는거만 찾는다.

...
public class Test027
{
	public static void main(String[] args) throws IOException
	{
		...
		// 수식2 : 수식 1의 처리 결과가 참(true)일 경우 수행하는 영역
		// 수식3 : 수식 1의 처리 결과가 거짓(false)일 경우 수행하는 영역
		...
		*/
		...
		strResult = "홀수";이렇게 쓰고 풀면은
		strResult = (n % 2 == 0) ? "짝수" : "홀수"; 이렇게 나옴
		*/
		strResult = (n % 2 == 0) ? "짝수" : "홀수";
		
		//strResult = (n % 2 == 0) ? "짝수" : "홀수"; n에 8을 넣으면
		...
		System.out.printf("%d -> %s\n", n, strResult);  // %는 println에 사용하지 못함.
		System.out.println("==================");
	}
}

...
class RpsGame
{
	...
	{
		String[] str = {"가위", "바위", "보"}; //1 - 가위, 2 - 바위, 3 - 보이지만 배열은 0,1,2

		System.out.println();
		System.out.println("유저 : " + str[user-1]);    //사용자가 낸 것)
		System.out.println("컴퓨터 : " + str[com-1]);    //컴퓨터가 낸 것)
	}
